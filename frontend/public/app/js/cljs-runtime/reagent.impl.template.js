...
var G__36741 = o;
reagent.impl.template.goog$module$goog$object.set(G__36741,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__36760__i < G__36760__a.length) {G__36760__a[G__36760__i] = arguments[G__36760__i + 0]; ++G__36760__i;}
  args = new cljs.core.IndexedSeq(G__36760__a,0,null);
} 
...
var G__36742 = o;
reagent.impl.template.goog$module$goog$object.set(G__36742,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__36764__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__36766__i < G__36766__a.length) {G__36766__a[G__36766__i] = arguments[G__36766__i + 0]; ++G__36766__i;}
  args = new cljs.core.IndexedSeq(G__36766__a,0,null);
} 
return G__36764__delegate.call(this,args);};
G__36764.cljs$lang$maxFixedArity = 0;
G__36764.cljs$lang$applyTo = (function (arglist__36767){
var args = cljs.core.seq(arglist__36767);
return G__36764__delegate(args);
});
...
var G__36743 = props;
var G__36743__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36743,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36743);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36743__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__36744 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36744,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__36744;
}
})(),id_class);
...
var G__36745 = (cljs.core.count(argv) - first_child);
switch (G__36745) {
case (0):
...
var vec__36746 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36746,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36746,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36746,(2),null);
...
var temp__5757__auto___36775 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___36775 == null)){
} else {
var key_36777 = temp__5757__auto___36775;
(jsprops.key = key_36777);
}
...
var temp__5757__auto___36778 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___36778 == null)){
} else {
var key_36779 = temp__5757__auto___36778;
(jsprops.key = key_36779);
}
...
var temp__5757__auto___36780 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___36780 == null)){
} else {
var key_36781 = temp__5757__auto___36780;
(jsprops.key = key_36781);
}
...
var temp__5757__auto___36787 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___36787 == null)){
} else {
var key_36788 = temp__5757__auto___36787;
(jsprops.key = key_36788);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36749_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__36749_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__36750 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36750,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36750,(1),null);
...
break;
default:
var G__36797 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__36798 = compiler;
v = G__36797;
compiler = G__36798;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template36756 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template36756 = (function (opts,id,fn_to_element,parse_fn,meta36757){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template36756.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36758,meta36757__$1){
var self__ = this;
var _36758__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template36756(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta36757__$1));
}));

(reagent.impl.template.t_reagent$impl$template36756.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36758){
var self__ = this;
var _36758__$1 = this;
return self__.meta36757;
}));

(reagent.impl.template.t_reagent$impl$template36756.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template36756.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template36756.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template36756.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template36756.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template36756.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta36757","meta36757",1061380718,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template36756.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template36756.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template36756");

(reagent.impl.template.t_reagent$impl$template36756.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template36756");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template36756.
 */
reagent.impl.template.__GT_t_reagent$impl$template36756 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template36756(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta36757){
return (new reagent.impl.template.t_reagent$impl$template36756(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta36757));
});

}

return (new reagent.impl.template.t_reagent$impl$template36756(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
