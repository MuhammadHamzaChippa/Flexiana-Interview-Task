...
var G__26698 = request;
var G__26699 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__26698,G__26699) : ajax.formats.get_format.call(null,G__26698,G__26699));
} else {
...
return cljs.core.some((function (p1__26703_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__26703_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__26707){
var map__26708 = p__26707;
var map__26708__$1 = cljs.core.__destructure_map(map__26708);
var request = map__26708__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26708__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__26715 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__26715.cljs$core$IFn$_invoke$arity$1 ? fexpr__26715.cljs$core$IFn$_invoke$arity$1(response) : fexpr__26715.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__26718){
var map__26719 = p__26718;
var map__26719__$1 = cljs.core.__destructure_map(map__26719);
var request = map__26719__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26719__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__26716_SHARP_){
return ajax.formats.get_accept_entries(request,p1__26716_SHARP_);
