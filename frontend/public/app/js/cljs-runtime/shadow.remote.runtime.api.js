...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30736 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30736(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_30737 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_30737(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_30739 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_30739(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_30742 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_30742(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30750 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30750(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30752 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30752(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__30727,callback){
var map__30728 = p__30727;
var map__30728__$1 = cljs.core.__destructure_map(map__30728);
var input = map__30728__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30728__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30728__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
